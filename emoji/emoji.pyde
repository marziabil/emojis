...
xValence = -0.4 #enter x coordinate here (only negative coordinates will work for now)
yArousal = 0.6 #enter y coordinate here (only negative coordinates will work for now)
