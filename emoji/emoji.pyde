...
xValence = -0.9 #enter x coordinate here (only negative coordinates will work for now)
yArousal = 0.4 #enter y coordinate here (only negative coordinates will work for now)
