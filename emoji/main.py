...
These can be tweaked by entering the x and y coordinates of the emotion from the circumplex model or by selecting an emotion.  
'''
import py5
...
'''
Enter a word below from the above or the Excel file 'Emotions and their coordinates' to generate an emoji. 
'''
...
#get emotional state from fuzzy logic
