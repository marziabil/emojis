...
window.geometry('1200x780') #set window size
...
arousalLabel = Label(window, text= "\nArousal refers to an emotion's intensity, that is, the strength of its associated emotional state.\nEnter a value between -1.0 (very low intensity) and 1.0 (very high intensity):", wraplength=1000, justify="center", font=("Calibri", 13), bg="white" )
...
emotionLabel.grid(column=0, row=10)
...
submitButton = Button(window, text="SUBMIT", bg="#cccccc", font=("Calibri", 15), fg="#1f1f2e", command=lambda:[validation(), buttonClicked()] , padx=50,height=1, width=1)
...
submitButton2 = Button(window, text="SUBMIT", bg="#cccccc", font=("Calibri", 15), fg="#1f1f2e" , padx=50,height=1, width=1)
submitButton2.grid(column=0, row=12)
